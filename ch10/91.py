...
if __name__ == "__main__":
    ...
    torch.save(model.module.state_dict(),'model_weight.pth') #nn.Dataparallelを使用した場合はmodel.state_dictではなくmodel.module.state_dictと書かなければいけない
